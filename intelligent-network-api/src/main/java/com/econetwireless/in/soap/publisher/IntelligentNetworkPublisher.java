...
import com.econetwireless.in.soap.pool.ThreadConnectionPool;
...
public class IntelligentNetworkPublisher {
    ...
    public static void  main(String ... publishingParameters) {
        ...
        IntelligentNetworkServiceImpl intelligentNetworkService = new IntelligentNetworkServiceImpl();
        Endpoint endpoint =Endpoint.create(intelligentNetworkService);
        endpoint.setExecutor(new ThreadConnectionPool());
